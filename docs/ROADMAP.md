...
| 3 | LSP Client | 3.1–3.5 | **In progress** (3.1-3.2 done) |
...
- 21/27 tools working (file, workflow, memory, git, config, semantic)
- LSP client operational (transport, lifecycle, JSON-RPC, initialize)
- 6 tools remaining: symbol (7, need LSP wiring), AST (2, need tree-sitter)
